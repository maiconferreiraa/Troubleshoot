            ...
            with conn.cursor() as cur:
                ...
                cur.execute("""
                    CREATE TABLE IF NOT EXISTS erros (
                        ...
                        -- user_email será adicionado separadamente, se necessário
                    )
                """)
                ...
                try:
                    ...
                    # Captura outros erros de alteração, mas permite que o restante do DB continue
                    app.logger.warning(f"⚠️ AVISO: Erro ao tentar adicionar coluna 'user_email', continuando... Detalhes: {e}")
