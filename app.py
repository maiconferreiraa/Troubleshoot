...
def export_pdf():
    ...
    # Função auxiliar definida fora do loop
    def clean_text(text):
        # Garante que qualquer tipo de dado seja string e usa latin-1 para compatibilidade FPDF
    ...
    # CORREÇÃO CRÍTICA: O método pdf.output(dest='S') JÁ retorna um objeto bytes.
    # O .encode('latin-1') foi removido para evitar a exceção.
